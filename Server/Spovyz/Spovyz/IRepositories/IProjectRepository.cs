...
namespace Spovyz.IRepositories
{
    public interface IProjectRepository
    {
        ...
        System.Threading.Tasks.Task PostProject(string Name, string? Description, Customer Customer, DateOnly? DeadLine, Enums.Status Status, Employee[] Employees, Tag[] Tags);
