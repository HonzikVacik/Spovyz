...
namespace Spovyz.IRepositories
{
    ...
    {
        System.Threading.Tasks.Task<List<Models.Project>> GetProjectList(uint ActiveUserId);
        System.Threading.Tasks.Task<Models.Project?> GetProjectById(uint ProjectId, uint activeUserId);
